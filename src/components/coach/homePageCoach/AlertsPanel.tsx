...
import { getPerformanceAlerts } from "../../../services/coach/alerts/alertsService";
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                setLoading(true);
                setError(null);
                const result = await getPerformanceAlerts({ coachId: user.id, days, limit });
                setAlerts(result);
            } catch (e: any) {
